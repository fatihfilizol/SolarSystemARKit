...
//  SolarSystemARKit
//
//  Created by Fatih Filizol on 4.09.2022.
//
...
class ViewController: UIViewController, ARSCNViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        //let mySphere = createSphere(radius: 0.1, content: "box.png", vector: SCNVector3(x: 0, y: 0.2, z: -1))
        
        let world = createSphere(radius: 0.1, content: "world.png", vector: SCNVector3(x: 0, y: 0.2, z: -1))
        let mars = createSphere(radius: 0.2, content: "mars.png", vector: SCNVector3(x: 0.4, y: 0.2, z: -1))
        let venus = createSphere(radius: 0.15, content: "venus.png", vector: SCNVector3(x: 0.8, y: 0.2, z: -1))
